...
\begin{scope}%[accent_r_1]
    \foreach \x [count=\ii from 0] in {0,\xstep,...,4.5} {
        ...
        \draw [line width = 2.5pt] (0+\x,1.5) -- (1.5+\x,1.5);
        \draw [line width = 2.5pt] (0+\x,1.5) -- (0+\x,3);
        \draw [line width = 2.5pt] (0+\x,0) -- (0+\x,1.5);
        \draw [line width = 2.5pt]   (0+\x,1.5) -- (1.5+\x,3);
        \draw [line width = 2.5pt]   (0+\x,3) -- (1.5+\x,1.5);
        \draw [line width = 2.5pt]   (0+\x,0) -- (1.5+\x,1.5);
        \draw [line width = 2.5pt]   (0+\x,1.5) -- (1.5+\x,0);
        \draw [line width = 0.8pt]   (0.75+\x,3) -- (0.75+\x,0);
        \draw [line width = 0.8pt]   (0+\x,0.75) -- (1.5+\x,0.75);
        \draw [line width = 0.8pt]   (0+\x,0.75+1.5) -- (1.5+\x,0.75+1.5);
        ...
        % \draw [line width = 1pt] (0+\x,0) -- (1.5+\x,0);
...
\draw[axis_gray,thick] (4.4,1.4) rectangle (6.1,3.1);
\draw[axis_gray] (6.2,2.25)  to[out=0,in=180] (8,1.2);
...
\begin{axis}[
    ...
    xmin = 0.7, xmax = 2.3,
    % xticklabels={$t=0$, $t=1$},
    xticklabels={\includegraphics[width=1cm]{module_1.pdf},\includegraphics[width=1cm]{module_2.pdf},}, % Include images as tick labels
    ylabel={$w$},
    ymin=0, ymax=1,
    bar width=0.4cm,
    % xmode=log,
