...
hide x axis,
hide y axis,
point meta max=1.00000000501473,
point meta min=0.123087073058308,
tick align=outside,
tick pos=left,
...
\path [draw=steelblue31119180, line width=0.0568514835881619pt]
(axis cs:0,360)
--(axis cs:360,360);
...
\path [draw=steelblue31119180, line width=0.46188021473591pt]
(axis cs:360,0)
--(axis cs:720,0);
