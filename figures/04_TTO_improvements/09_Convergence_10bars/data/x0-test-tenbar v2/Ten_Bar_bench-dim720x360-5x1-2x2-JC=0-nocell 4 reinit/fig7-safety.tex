...
hide x axis,
hide y axis,
point meta max=1.00000000009931,
point meta min=0.103503478436231,
tick align=outside,
tick pos=left,
...
\path [draw=steelblue31119180, line width=0.056851483770104pt]
(axis cs:0,360)
--(axis cs:360,360);
...
\path [draw=steelblue31119180, line width=0.461880215336321pt]
(axis cs:360,0)
--(axis cs:360,360);

\path [draw=steelblue31119180, line width=0.160800278787741pt]
(axis cs:360,0)
--(axis cs:0,360);

\path [draw=steelblue31119180, line width=0.77678683471719pt]
(axis cs:360,0)
--(axis cs:720,360);
