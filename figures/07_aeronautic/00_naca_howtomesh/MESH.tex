...
\node[inner sep=0pt,label={[label distance=0cm,color=black]90:Volume}] (00) at (0,0)
...
\node[inner sep=0pt, right=of 01,label={[label distance=0cm,color=black]90:Repartition}] (02)
  {\includegraphics[width=\imglen cm]{03_cell_GS.png}};

\node[inner sep=0pt, below=of 00, xshift=0.7cm] (03)
  {\includegraphics[width=\imglen cm]{04_mesh_1.png}};

\node[inner sep=0pt, right=of 03, xshift=-1.4cm] (04)
