...
\node [black,text width=8cm, align=center] at (4,-5.5) {\small
\begin{equation*}
    \begin{split}
        \frac{\partial(\cdot)_i}{\partial\bar{\bm{a}}_{t=0}} ={} & 1\times\frac{\partial(\cdot)_i}{\partial \bm{a}^0}+1\times\frac{\partial(\cdot)_i}{\partial \bm{a}^1}+1\times\frac{\partial(\cdot)_i}{\partial \bm{a}^2}+1\times\frac{\partial(\cdot)_i}{\partial \bm{a}^3}+\\
        &0\times\frac{\partial(\cdot)_i}{\partial \bm{a}^4}+0\times\frac{\partial(\cdot)_i}{\partial \bm{a}^5}+0\times\frac{\partial(\cdot)_i}{\partial \bm{a}^6}+0\times\frac{\partial(\cdot)_i}{\partial \bm{a}^7}
    \end{split}
\end{equation*}   
};
