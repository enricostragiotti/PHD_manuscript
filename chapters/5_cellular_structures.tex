...
\end{bNiceMatrix}
\end{equation}
as the lower submodules (numbered from 0 to 3) exhibit the topology of module $t=0$, while the upper submodules (numbered 4 to 7) represent the topology of module $t=1$.}
\begin{equation}
    G_{j,t} =
    \begin{cases}
...
quindi conferma del bisogno di usare l nlp con i kinematic constraints
